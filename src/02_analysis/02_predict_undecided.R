...
for (i in seq_along(tune_alpha)) {
  alpha <- tune_alpha[i]
  set.seed(303493)
  eval(parse(text=paste("xgb_u1a <- train(",model_u1,",
...
for (i in seq_along(tune_alpha)) {
  alpha <- tune_alpha[i]
  set.seed(303493)
  eval(parse(text=paste("xgb_u2a <- train(",model_u2,",
                        data = X_back_track_train,
                        method = 'xgbTree',
                        trControl = ctrl,
                        tuneGrid = xgb_grid0,
...
for (i in seq_along(tune_alpha)) {
  alpha <- tune_alpha[i]
  set.seed(303493)
  eval(parse(text=paste("xgb_u3a <- train(",model_u3,",
                        data = X_back_track_train,
                        method = 'xgbTree',
                        trControl = ctrl,
                        tuneGrid = xgb_grid0,
...
for (i in seq_along(tune_alpha)) {
  alpha <- tune_alpha[i]
  set.seed(303493)
  eval(parse(text=paste("xgb_u4a <- train(",model_u4,",
                        data = X_back_track_train,
                        method = 'xgbTree',
                        trControl = ctrl,
                        tuneGrid = xgb_grid0,
...
for (i in seq_along(tune_alpha)) {
  alpha <- tune_alpha[i]
  set.seed(303493)
  eval(parse(text=paste("xgb_u5a <- train(",model_u5,",
                        data = X_back_track_train,
                        method = 'xgbTree',
                        trControl = ctrl,
                        tuneGrid = xgb_grid0,
...
for (i in seq_along(tune_alpha)) {
  alpha <- tune_alpha[i]
  set.seed(303493)
  eval(parse(text=paste("xgb_u6a <- train(",model_u6,",
                        data = X_back_track_train,
                        method = 'xgbTree',
                        trControl = ctrl,
                        tuneGrid = xgb_grid0,
...
c_xgb_u2 <- as.factor(ifelse(p_xgb_u2$undecided > roc_xgb_u1_t[1], "undecided", "decided"))
c_xgb_u3 <- as.factor(ifelse(p_xgb_u3$undecided > roc_xgb_u1_t[1], "undecided", "decided"))
c_xgb_u4 <- as.factor(ifelse(p_xgb_u4$undecided > roc_xgb_u1_t[1], "undecided", "decided"))
c_xgb_u5 <- as.factor(ifelse(p_xgb_u5$undecided > roc_xgb_u1_t[1], "undecided", "decided"))
c_xgb_u6 <- as.factor(ifelse(p_xgb_u6$undecided > roc_xgb_u1_t[1], "undecided", "decided"))
