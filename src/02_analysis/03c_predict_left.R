...
small <- ncol(model.matrix(eval(parse(text=model_l1)), X_back_track_train))
med <- ncol(model.matrix(eval(parse(text=model_l2)), X_back_track_train))
...
resamps <- resamples(list(xgb_l1, xgb_l2, xgb_l3, xgb_l4, xgb_l5, xgb_l6))
summary(resamps)
